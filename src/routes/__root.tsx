    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          This route doesn't exist in the network. Let's get you back on course.
        </p>
        <div className="mt-6">
          <Link
            to="/"
  ...
  head: () => ({
    meta: [
      ...
      { title: "TransitOps — Smart Transport Operations Platform" },
      {
        name: "description",
        content:
          "TransitOps is a centralized fleet command center for vehicles, drivers, dispatch, maintenance, fuel, and analytics — with automatic status transitions and enforced business rules.",
      },
      ...
      { property: "og:title", content: "TransitOps — Smart Transport Operations Platform" },
      {
        ...
        content:
          "Digitize your entire transport operation: fleet, drivers, dispatch, maintenance, expenses, and insights.",
      },
